...
@Component({
  selector: 'app-graphson',
  templateUrl: './graphson.component.html',
  styleUrls: ['./graphson.component.scss']
})
export class GraphsonComponent implements OnInit, OnDestroy {
  ...
  onSubmit() {
    ...
    this.toggle();
    this.subscription.add(this.generatorService.graphsonCalculation(wrap)
      .subscribe(data => {
  ...
  onGenerate() {
    ...
    this.subscription.add(this.generatorService.graphsonGeneration(wrap)
      .subscribe(data => {
